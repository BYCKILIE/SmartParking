...
/** Slick data model trait for extension, choice of backend or usage in the cake pattern. (Make sure to initialize this late.)
  ...
  */
trait Tables extends TablesRoot with CarsTable with CredentialsTable with UsersTable {
  ...
  lazy val schema: profile.SchemaDescription = Cars.schema ++ Credentials.schema ++ Users.schema
